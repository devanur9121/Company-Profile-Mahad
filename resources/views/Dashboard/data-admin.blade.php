      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Data Admin Terdaftar</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        <div class="card-title">
          <h4 class="mb-0">DATA ADMIN MA'HAD
              ...
              <tr>
                ...
                <td class="no-export">
                  <button data-toggle="modal" data-target="#myModalEdit{{$data->id}}"
                    data-nama_lengkap="{{ $data->nama_lengkap}}" data-username="{{$data->username}}"
                    data-email="{{$data->email}}" class="btn btn-warning"><i class="bx bx-edit"></i></button>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">HAPUS DATA ADMIN</h4><button type="button" class="btn-close"
                        data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form method="post" enctype="multipart/form-data" action="/data-admin/delete/{{$data->id}}">
                      @csrf
                      @method('DELETE')
              ...
              <div id="myModalEdit{{$data->id}}" class="modal fade" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form method="post" enctype="multipart/form-data" action="/data-admin/update/{{$data->id}}">
                      @csrf
                      @method('PUT')
                        ...
                        <div class="container-fluid">
                          ...
                          <div class="form-group col-md-12 mb-2">
                            ...
                            <input name="nama_lengkap" type="text"
                              ...
                              placeholder="Masukkan Nama Lengkap" id="nama_lengkap" value="{{$data->nama_lengkap}}">
                          </div>
                          <div class="form-group col-md-12 mb-2">
                            <label>Email</label>
                            <input name="email" type="text" class="form-control @error('email') is-invalid @enderror"
                              placeholder="Masukkan Email" id="no_hp" value="{{$data->email}}">
                          </div>
                          <div class="form-group col-md-12 mb-2">
                            <label>Username</label>
                            <input name="username" type="integer"
                              class="form-control @error('username') is-invalid @enderror"
                              placeholder="Masukkan NIP sebagai Username" id="username" value="{{$data->username}}">
                          </div>
                          <div class="form-group col-md-12 mb-2">
          ...
          <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="/data-admin">
                  @csrf
                  <div class="modal-body">
                    <div class="container-fluid">
                      ...
                      <div class="form-group mb-2">
                        ...
                        <input name="email" type="text" class="form-control @error('email') is-invalid @enderror"
                          id="email" placeholder="Masukkan Email Anda" value="" required>
                      </div>

                      <div class="form-group mb-2">
                        <label for="username">Username</label>
                        <input name="username" type="text" class="form-control @error('username') is-invalid @enderror"
                          id="username" placeholder="Masukkan NIP Sebagai Username" value="" required>
                      </div>
