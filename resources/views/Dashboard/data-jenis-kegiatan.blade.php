        ...
        <div class="table-responsive">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="no-export">
                  <button data-toggle="modal" data-target="#myModalEdit{{$data->id}}"
                    data-jenis_kegiatan="{{ $data->jenis_kegiatan}}" class="btn btn-warning"><i
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">HAPUS DATA JENIS KEGIATAN</h4><button type="button" class="btn-close"
                        data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form method="post" enctype="multipart/form-data"
                      action="/data-jenis-kegiatan/delete/{{$data->id}}">
                      @csrf
                      @method('DELETE')
              ...
              <div id="myModalEdit{{$data->id}}" class="modal fade" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">EDIT DATA JENIS KEGIATAN</h4>
                      <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form method="post" enctype="multipart/form-data"
                      action="/data-jenis-kegiatan/update/{{$data->id}}">
                      @csrf
                      @method('PUT')
                      <div class="modal-body">
                        <div class="container-fluid">
                          ...
                          <div class="form-group col-md-12 mb-2">
                            ...
                            <input name="jenis_kegiatan" type="text"
                              class="form-control @error('jenis_kegiatan') is-invalid @enderror"
                              placeholder="Masukkan Jenis Kegiatan" id="jenis_kegiatan"
          ...
          <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">TAMBAH DATA JENIS KEGIATAN</h4>
                  <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post" enctype="multipart/form-data" action="/data-jenis-kegiatan">
                  @csrf
                  <div class="modal-body">
                    <div class="container-fluid">
                      ...
                      <div class="form-group mb-2">
                        ...
                        <input name="jenis_kegiatan" type="text"
                          class="form-control @error('jenis_kegiatan') is-invalid @enderror" id="nama_lengkap"
                          placeholder="Masukkan Jenis Kegiatan" value="" required>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
