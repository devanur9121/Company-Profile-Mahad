          ...
          <div class="single-blog-post-wrap">
            ...
            <div class="single-blog-post-content">
              ...
              <div class="single-blog-post-Info">
                ...
                <small>/</small>
                <span><i class="icofont-comment"></i>{{ $item->commentCount }} Comments</span>
                <small>/</small>
            ...
            <div class="site-pagination">
              <div class="navbar justify-content-center">
                <ul class="pagination">
                  ...
                  @else
                  <li class="page-item"><a class="page-link" href="{{ $news->previousPageUrl() }}" rel="prev"
                  ...
                  <li class="page-item"><a class="page-link" href="{{ $news->nextPageUrl() }}" rel="next"
